...
import { mouseSexingExamples } from "@/data/sexing";
...
export function SexingExplorer() {
  ...
  const male = mouseSexingExamples.find((e) => e.sex === "male");
  const female = mouseSexingExamples.find((e) => e.sex === "female");
  const references = mouseSexingExamples.filter((e) => e.sex === "both");
